...
def fun_process_dates(tbl, column, format):
    """
    Transforms dates and returns additional columns(month, year, year_month, year_month_start, year_month_end, day_year)
    ...
    try:
        ...
        tbl["year_month_start"] = tbl[column] + MonthBegin(0)
        
        #Last day of the month
        tbl["year_month_end"] = tbl[column] + MonthEnd(0)

        #Day of the year
        tbl["day_year"] = tbl[column].dt.dayofyear
